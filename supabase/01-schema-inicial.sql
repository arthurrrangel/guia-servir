/* ESTE ARQUIVO E PASSADO. A TRANCA ESTA AQUI PORQUE ELE PODE DESFAZER.
   ...
   O que este arquivo consegue reverter, se rodar fora de hora:
     eu_dados (a 38 refez), eu_proximos_domingos (a 9 refez), fn_conflito_simultaneo (a 45 refez), fn_indisponivel (a 46 refez), is_lider (a 3 refez), salvar_dia (a 54 refez)
