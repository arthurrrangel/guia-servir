/* ESTE ARQUIVO E PASSADO. A TRANCA ESTA AQUI PORQUE ELE PODE DESFAZER.
   ...
   O que este arquivo consegue reverter, se rodar fora de hora:
     equipe_publica (a 7 refez), fn_conflito_simultaneo (a 45 refez), fn_indisponivel (a 46 refez), salvar_dia (a 54 refez)

   Por isso ele se recusa a rodar num banco que ja passou da 6. Aplicado na
...
do $tranca$ begin
  if to_regprocedure('public.exige_versao_ate(int)') is not null then
    perform public.exige_versao_ate(6);
  end if;
end $tranca$;
