/* ESTE ARQUIVO E PASSADO. A TRANCA ESTA AQUI PORQUE ELE PODE DESFAZER.
   ...
   O que este arquivo consegue reverter, se rodar fora de hora:
     equipe_pin_criar (a 44 refez), equipe_pin_entrar (a 31 refez)

   Por isso ele se recusa a rodar num banco que ja passou da 30. Aplicado na
...
do $tranca$ begin
  if to_regprocedure('public.exige_versao_ate(int)') is not null then
    perform public.exige_versao_ate(30);
  end if;
end $tranca$;
