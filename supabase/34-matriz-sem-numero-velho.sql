/* ESTE ARQUIVO E PASSADO. A TRANCA ESTA AQUI PORQUE ELE PODE DESFAZER.
   ...
   O que este arquivo consegue reverter, se rodar fora de hora:
     testar_permissoes (a 60, a 70 e a 74 refizeram: reaplicar aqui derruba a
     bateria de 68 casos para a versao de agosto, e o piso do banco-do-zero quebra)

   Por isso ele se recusa a rodar num banco que ja passou da 34. Aplicado na
...
do $tranca$ begin
  if to_regprocedure('public.exige_versao_ate(int)') is not null then
    perform public.exige_versao_ate(34);
  end if;
end $tranca$;
