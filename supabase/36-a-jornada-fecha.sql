/* ESTE ARQUIVO E PASSADO. A TRANCA ESTA AQUI PORQUE ELE PODE DESFAZER.
   ...
   O que este arquivo consegue reverter, se rodar fora de hora:
     candidatura_status (a 64 refez: reaplicar aqui devolve a chave no corpo da
     resposta publica de acompanhamento)

   Por isso ele se recusa a rodar num banco que ja passou da 36. Aplicado na
...
do $tranca$ begin
  if to_regprocedure('public.exige_versao_ate(int)') is not null then
    perform public.exige_versao_ate(36);
  end if;
end $tranca$;
