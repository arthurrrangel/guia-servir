/* ESTE ARQUIVO E PASSADO. A TRANCA ESTA AQUI PORQUE ELE PODE DESFAZER.
   ...
   O que este arquivo consegue reverter, se rodar fora de hora:
     salvar_dia e o robo (a 78 refez culto_guarda em cima)

   Por isso ele se recusa a rodar num banco que ja passou da 66. Aplicado na
...
do $tranca$ begin
  if to_regprocedure('public.exige_versao_ate(int)') is not null then
    perform public.exige_versao_ate(66);
  end if;
end $tranca$;
